...
document.querySelectorAll('.box').forEach(item => {
    ...
    if (tog % 2 !== 0 && aup < 800) {
        // Código executado quando 'tog' é ímpar e 'aup' é menor que 800

        // Andar uma casa para frente
        if (document.getElementById(`b${a + 100}`).innerText.length == 0) {
            document.getElementById(`b${a + 100}`).style.backgroundColor = 'green';
        }

        // Andar duas casas para frente
        if (aup < 700 && document.getElementById(`b${a + 200}`).innerText.length == 0 && document.getElementById(`b${a + 100}`).innerText.length == 0) {
            document.getElementById(`b${a + 200}`).style.backgroundColor = 'green';
        }

        // Capturar peça à direita
        if (aside < 8) {
            if (document.getElementById(`b${a + 101}`).innerText.length !== 0) {
                document.getElementById(`b${a + 101}`).style.backgroundColor = 'green';
            }
        }

        // Capturar peça à esquerda
        if (aside > 1) {
            if (document.getElementById(`b${a + 99}`).innerText.length !== 0) {
    ...
    if (tog % 2 == 0 && aup > 100) {
        // Código executado quando 'tog' é par e 'aup' é maior que 100

        // Andar uma casa para trás
        if (document.getElementById(`b${a - 100}`).innerText.length == 0) {
            document.getElementById(`b${a - 100}`).style.backgroundColor = 'green';
        }

        // Andar duas casas para trás
        if (aup > 200 && document.getElementById(`b${a - 200}`).innerText.length == 0 && document.getElementById(`b${a - 100}`).innerText.length == 0) {
            document.getElementById(`b${a - 200}`).style.backgroundColor = 'green';
        }
